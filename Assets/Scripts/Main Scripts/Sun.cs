...
public class Sun : MonoBehaviour
{
    ...
    {
        Target.transform.position = new Vector3(SliderDis.value + (-1500) , 500, -SliderDis.value + (1500));
    ...
    public void Sun_Rotation()
    {
        ...
        transform.RotateAround(Vector3.zero, new Vector3(1,0,1), -speed * Time.deltaTime);
        transform.LookAt(Vector3.zero);
    }
